...
class Solution:
    ...
    def mostCommonWord(self, paragraph):
        ...
        paragraph = ''.join([c if c not in PUNCTUATIONS else ' ' for c in paragraph])
        words = sorted([word.lower() for word in paragraph.split(' ')], reverse=True)
...
if __name__ == '__main__':
    ...
    print(s.mostCommonWord(paragraph))